      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const AvBrandLockup(markSize: 40, fontSize: 19),
              const SizedBox(height: AvSpace.xxl),
              Text(
                creating ? 'Create your account' : 'Welcome back',
                style: AvType.displayMedium.primary,
              ),
              ...
              _ProviderButton(
                ...
                border: AvColors.hairlineStrong,
                onPressed: () => context.go(AppRoute.role),
              ),
              ...
              AvTintCard(
                ...
                borderColor: AvColors.court.withValues(alpha: 0.2),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const AvGlyph(
